...
const App = () => {
  ...
  const [shouldShowSelectCharacters, setShouldShowSelectCharacters] = useState(false);
  ...
  const renderContent = () => {
    ...
    } else if (currentAccount && (!characterNFTs ||  characterNFTs.length === 0 || shouldShowSelectCharacters)){
      return <SelectCharacter characterNFTs={characterNFTs} setCharacterNFTs={setCharacterNFTs} setShouldShowSelectCharacters={setShouldShowSelectCharacters}/>;
    } else if (currentAccount && characterNFTs) {
      return <Arena characterNFTs={characterNFTs} setCharacterNFTs={setCharacterNFTs} setShouldShowSelectCharacters={setShouldShowSelectCharacters}/>;
    }
  }
